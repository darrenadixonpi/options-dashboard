async function openRollModal(pos) {
  ...
  const sel = document.getElementById("roll-target-expiry");
  const analyzeBtn = document.getElementById("btn-analyze-roll");
  ...
  analyzeBtn.addEventListener("click", async () => {
    const targetExpiry = document.getElementById("roll-target-expiry").value;
    const targetStrike = parseFloat(document.getElementById("roll-target-strike").value);
...
document.getElementById("roll-modal")?.addEventListener("click", (e) => { if (e.target.id === "roll-modal") document.getElementById("roll-modal").hidden = true; });
...
document.getElementById("btn-add-catalyst")?.addEventListener("click", async () => {
  const ticker = document.getElementById("cat-ticker").value.trim().toUpperCase();
  ...
  document.getElementById("cat-ticker").value = "";
  document.getElementById("cat-date").value = "";
  document.getElementById("cat-label").value = "";
  loadCatalysts();
});

window.deleteCatalyst = async function(id) {
