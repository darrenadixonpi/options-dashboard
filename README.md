...
Release: **v1.6.0** — see [CHANGELOG.md](CHANGELOG.md).
...
|--------|-------|-------------|
| `GET` | `/api/version` | `{"name":"options-dashboard","version":"1.6.0"}` |
